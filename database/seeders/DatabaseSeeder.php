...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedInputs(): void
    {
        ...
        $inputs = [
            ...
            ['code' => 'SV-MAQUILA', 'name' => 'Maquila de producción', 'category' => 'Servicios', 'type' => 'material', 'unit' => 'unidad', 'unit_cost' => 3400, 'stock' => 5000, 'transit' => 0, 'safety_stock' => 500, 'weekly_consumption' => 200, 'lead_time_days' => 0, 'target_weeks' => 2, 'min_purchase' => 100, 'purchase_multiple' => 100, 'supplier_id' => $s2->id],
