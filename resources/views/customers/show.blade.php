<x-erp-layout title="Detalle: {{ $customer->business_name }}" subtitle="Información completa del registro.">
    <div class="card">
        <div class="card__header">
            <h2 class="card__title">Cliente</h2>
            <a href="{{ route('customers.index') }}" class="btn-outline-info btn-sm">← Volver</a>
        </div>
