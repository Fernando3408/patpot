    <div class="detail-grid-2col">
        <div><strong>Numero:</strong> {{ $production->number }}</div>
        ...
        <div><strong>Cajas reales:</strong> {{ $production->actual_boxes ? number_format($production->actual_boxes, 0, ',', '.') : '—' }}</div>
        <div class="col-span-full"><strong>Notas:</strong> {{ $production->notes ?? '—' }}</div>
    </div>
