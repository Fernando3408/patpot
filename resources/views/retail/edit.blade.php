<form method="POST" action="/retail/{{ $retail->id }}">
    ...
    <div class="form-section-header">Editar registro retail</div>
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input id="stock_units" type="number" step="1" min="0" name="stock_units" class="form-control @error('stock_units') is-invalid @enderror" value="{{ old('stock_units', (int)$retail->stock_units) }}" required>
            @error('stock_units')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input id="transit_units" type="number" step="1" min="0" name="transit_units" class="form-control @error('transit_units') is-invalid @enderror" value="{{ old('transit_units', (int)$retail->transit_units) }}" required>
            @error('transit_units')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input id="weekly_sales" type="number" step="1" min="0" name="weekly_sales" class="form-control @error('weekly_sales') is-invalid @enderror" value="{{ old('weekly_sales', (int)$retail->weekly_sales) }}" required>
            @error('weekly_sales')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input id="min_stock" type="number" step="1" min="0" name="min_stock" class="form-control @error('min_stock') is-invalid @enderror" value="{{ old('min_stock', (int)$retail->min_stock) }}" required>
            @error('min_stock')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input id="reorder_point" type="number" step="1" min="0" name="reorder_point" class="form-control @error('reorder_point') is-invalid @enderror" value="{{ old('reorder_point', (int)$retail->reorder_point) }}" required>
            @error('reorder_point')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
